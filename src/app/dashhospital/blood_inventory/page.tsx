...
const RecordIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z" /></svg>;
...
function BloodbankSidebar({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
    ...
    const links = [
        ...
        { name: "Nearby Blood Record", href: "/dashhospital/near_blood_bag", icon: <RecordIcon /> },
    ];
...
export default function ManageInventory() {
    ...
    const exportPDF = () => {
        ...
        doc.setFontSize(18);
        doc.text("Blood Inventory Report", 14, 22);
        ...
        doc.save(`hospital_inventory_report_${new Date().toISOString()}.pdf`);
    };
    ...
    const printQr = () => {
        ...
        html2canvas(qrElement).then((canvas: HTMLCanvasElement) => {
