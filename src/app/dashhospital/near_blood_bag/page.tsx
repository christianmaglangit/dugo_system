              ...
              <div className="flex flex-col md:flex-row justify-between items-center mb-4 gap-4">
                ...
                <div className="w-full md:w-auto">
                  <div className="relative">
                    ...
                    <input type="text" placeholder="Search by type, location..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="w-full dark:text-gray-700 pl-10 pr-4 py-2.5 border rounded-lg shadow-sm text-sm focus:outline-none focus:ring-2 focus:ring-red-400"/>
                  </div>
                </div>
              </div>
                    ...
                    (
                        filteredData.map((blood) => (
                          <tr key={blood.id} className="hover:bg-gray-50">
                            ...
                            <td className="p-4 dark:text-gray-700 text-center font-semibold">{blood.units}</td>
                            <td className="p-4 text-gray-600">{blood.expiration_date}</td>
                            <td className="p-4 dark:text-gray-700 text-left">{blood.status}</td>
