...
export default function HospitalQRScanner() {
  ...
  // Formatter for displaying the date and time in Philippine time
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-6">
                        <div className="flex flex-col md:flex-row justify-between items-center mb-4 gap-4">
                            ...
                            <div className="flex items-center gap-2 w-full md:w-auto">
                                {isFiltered && <button onClick={() => fetchBloodJourney()} className="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg text-sm font-semibold hover:bg-gray-300 transition">Clear Filter</button>}
                                ...
                                <tbody className="divide-y divide-gray-200">
                                    ...
                                    <tr key={row.donation_id} className="hover:bg-gray-50">
                                        ...
                                        <td className="p-4 text-gray-600">
                                            {/* ✅ Format the UTC time string correctly before converting */}
